...
import { CustomModal } from '../cui/CustomModal';
import SelectPaymentOption from '../cui/SelectPaymentOption';
          ...
          <div id='package' key={item._id} className='p-4 lg:p-6 rounded-2xl customShadow4 flex flex-col bg-white'>
            ...
            <div className='flex-1 flex flex-col'>
              ...
              <div className='flex-1 flex flex-col justify-end'>
                <Button onClick={() => handleSelectPackage(item?._id)} className='w-full mt-4' variant="customYellow">Select</Button>
              </div>
            </div>
          </div>
        ))}
...
{/*
<div div className = 'flex-1 flex flex-col justify-end' >
