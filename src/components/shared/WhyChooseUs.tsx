    ...
    <div className='relative'>
      ...
      <div className='relative maxWidth'>
        {whyChoseUsDatas?.map((item:whyChoseUsType)=>(
          <div key={item.id} className='sticky top-32 md:top-68 w-full bg-white border-2 h-[520px] md:h-[300px] px-4 lg:px-8 flex flex-col items-center justify-center rounded-md mt-20 overflow-hidden'>
